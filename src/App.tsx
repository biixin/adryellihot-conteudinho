          ...
          <main className="w-full max-w-[1100px] mx-auto px-4 py-5 pb-10 flex flex-col gap-6">
                ...
                <div className="w-full max-w-4xl">
                  <ProductCard
                    ...
                    benefits={[
                      ...
                      { icon: 'lock', text: '🔒 Até gozar' }
                    ]}
                    videoUrl=""
                    productName="Chamada de Vídeo"
                    redirectUrl="https://chamada-aovivo.vercel.app/"
                    isCompact={true}
                  />
                </div>
              </div>
            ...
            <section className="flex flex-col gap-7">
              ...
              {[
                ...
                { type: 'video', num: 12, time: '23 de jan, 07:55' },
                { type: 'video', num: 13, time: '23 de jan, 06:20' },
                { type: 'video', num: 14, time: '22 de jan, 23:40' },
                { type: 'video', num: 15, time: '22 de jan, 22:15' },
                { type: 'video', num: 16, time: '22 de jan, 21:30' },
                { type: 'video', num: 17, time: '22 de jan, 20:45' },
                { type: 'image', num: 18, time: '22 de jan, 19:22' },
                { type: 'video', num: 19, time: '22 de jan, 18:10' },
                { type: 'video', num: 20, time: '22 de jan, 17:05' },
                { type: 'image', num: 21, time: '22 de jan, 16:33' },
                { type: 'video', num: 22, time: '22 de jan, 15:48' },
                { type: 'video', num: 23, time: '22 de jan, 14:20' },
                { type: 'video', num: 24, time: '22 de jan, 13:15' },
                { type: 'video', num: 25, time: '22 de jan, 12:40' },
                { type: 'video', num: 26, time: '22 de jan, 11:55' },
                { type: 'video', num: 27, time: '22 de jan, 10:30' },
                { type: 'video', num: 28, time: '22 de jan, 09:45' },
                { type: 'video', num: 29, time: '22 de jan, 08:22' },
                { type: 'video', num: 30, time: '22 de jan, 07:10' },
                { type: 'video', num: 31, time: '22 de jan, 06:35' },
                { type: 'image', num: 32, time: '21 de jan, 23:50' },
                { type: 'video', num: 33, time: '21 de jan, 22:25' },
                { type: 'image', num: 34, time: '21 de jan, 21:40' },
                { type: 'video', num: 35, time: '21 de jan, 20:55' },
                { type: 'image', num: 36, time: '21 de jan, 19:32' },
                { type: 'video', num: 37, time: '21 de jan, 18:20' },
                { type: 'image', num: 38, time: '21 de jan, 17:15' },
                { type: 'video', num: 39, time: '21 de jan, 16:43' },
                { type: 'image', num: 40, time: '21 de jan, 15:58' },
                { type: 'video', num: 41, time: '21 de jan, 14:30' },
                { type: 'image', num: 42, time: '21 de jan, 13:55' },
                { type: 'video', num: 43, time: '21 de jan, 12:50' },
                { type: 'image', num: 44, time: '21 de jan, 11:25' },
                { type: 'video', num: 45, time: '21 de jan, 10:32' },
                { type: 'image', num: 46, time: '21 de jan, 09:20' },
                { type: 'video', num: 47, time: '21 de jan, 08:45' },
                { type: 'image', num: 48, time: '21 de jan, 07:30' },
                { type: 'video', num: 49, time: '21 de jan, 06:15' },
                { type: 'image', num: 50, time: '20 de jan, 23:40' },
              ].map((post, idx) => (
